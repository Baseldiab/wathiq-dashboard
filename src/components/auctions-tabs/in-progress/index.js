...
export default function InProgress() {
  ...
  const tabItems = [
    {
      text: t("components_auctions-tabs_in-progress_index.مزادات_خاصة"),
      id: 1,
    },
    { text: t("components_auctions-tabs_in-progress_index.هيئة_إنفاذ"), id: 2 },
  ];
      ...
      >
        ...
        >
          <CustomButton
            ...
            text={t("components_auctions-tabs_in-progress_index.إنشاء_مزاد")}
            // type="add"
          />
        </Box>{" "}
      </Box>
