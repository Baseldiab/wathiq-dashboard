...
export default function UnderConstruction() {
  ...
  const tabItems = [
    {
      text: t("components_auctions-tabs_under-construction_index.مزادات_خاصة"),
      id: 1,
    },
    {
      text: t("components_auctions-tabs_under-construction_index.هيئة_إنفاذ"),
      id: 2,
    },
  ];
  ...
  console.log("profile?.data?.type", profile?.data?.type);
      ...
      >
        ...
        >
          <CustomButton
            ...
            text={t(
              "components_auctions-tabs_under-construction_index.إنشاء_مزاد"
            )}
            // type="add"
